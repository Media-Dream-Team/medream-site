  ...
  return (
    <section className="bg-surface-tint py-10 md:py-14 px-4">
      ...
      <div className="relative max-w-6xl mx-auto rounded-[28px] overflow-hidden bg-gradient-dawn">
        <div aria-hidden="true" className="absolute inset-0 bg-midnight/45" />
        <div className="relative z-10 max-w-xl mx-auto text-center py-24 px-5">
          ...
          <Link
            href={`/${locale}/contact`}
            className="inline-flex items-center gap-2 font-display font-bold text-[15px] text-navy bg-first-light rounded-full px-8 py-4 transition-transform duration-200 ease-out hover:-translate-y-0.5 focus-visible:outline focus-visible:outline-[3px] focus-visible:outline-sky focus-visible:outline-offset-[3px]"
          >
